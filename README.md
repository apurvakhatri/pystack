...
compiler where to find the header and library files of the dependencies for the build to succeed. This is handled at Pystack level provided the users install pkg-config (e.g.,
